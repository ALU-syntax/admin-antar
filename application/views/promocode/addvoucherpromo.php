                    ...
                    <div class="col-md-6 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Tambah Voucher Promo</h4>
                            </div>
                            <br>
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <?php endif; ?>
                                    <?= form_open_multipart('promocode/addVoucherPromo'); ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <div class="custom-file">
                                                            <input type="file" class="custom-file-input dropify" name="image_voucher_promo" data-max-file-size="3mb" required>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="nama_voucher_promo" name="nama_voucher_promo" placeholder="judul promo" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="select2 form-group"  name="type_voucher_promo" style="width:100%" onchange="admSelectCheck(this);">
                                                ...
                                                <div id="persencheck" class="col-12 form-group" style="display:block;">
                                                    ...
                                                    <input id="persencheckrequired" type="text" class="form-control" id="nominal_voucher_promo" name="nominal_voucher_promo_persen" placeholder="enter promo amount" required>
                                                </div>
                                                <div id="fixcheck" class="col-12 form-group" style="display:none;">
                                                    <label>Fix Promo Amount</label>
                                                    <input id="fixcheckrequired" type="text" pattern="^\d+(\.|\,)\d{2}$" data-type="currency" class="form-control" id="nominal_voucher_promo" name="nominal_voucher_promo" placeholder="enter promo amount">
                                                </div>
